...
Rooms.join = function () {
	...
	send('|/join groupchat-icekyubs-one');
	send('|/join groupchat-icekyubs-two');
	send('|/join groupchat-icekyubs-three');
	send('|/join groupchat-icekyubs-four');
	send('|/join groupchat-icekyubs-five');
	send('|/join groupchat-icekyubs-six');
};
