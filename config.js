...
exports.nick = 'Ice Kyubs';
exports.pass = 'rainYAUtumnleafdance139';

// The rooms that should be joined.
// Joining Smogon's Showdown's Lobby is not allowed.
exports.rooms = ['battledome','competitive tutoring','mafia','pokemongo','cafelewow'];
...
exports.excepts = ['mmm', 'afkmmm', 'taistelu', 'asthmeresivolisk', 'vulcaron', 'taitest', 'busytai', 'trophyname','wonto','sawanosama','wontowonders','maillog','shakujil','credstik','kiminonawa','aelita', 'midy'];
...
exports.allowmute = false; //via request from MMM - Vulcaron
